            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo e(url('dist/img/avatar.jpg')); ?>" class="user-image" alt="User Image">
                            <span class="hidden-xs">JellyBean</span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="user-header">
                                <img src="<?php echo e(url('dist/img/avatar.jpg')); ?>" class="img-circle" alt="User Image">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo e(url('/admin/profile')); ?>"><i class="fa fa-circle-o"></i>管理员</a></li>
                        <li><a href="<?php echo e(url('/admin/users')); ?>"><i class="fa fa-circle-o"></i>系统用户</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo e(url('admin/article/index')); ?>"><i class="fa fa-circle-o"></i>文章</a></li>
