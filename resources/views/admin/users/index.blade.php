                ...
                <form action="/admin/users" method="get">
                    <div class="input-group">
                        <input type="text" class="form-control input-sm pull-right" name="keywords"
                               style="width: 150px;" placeholder="搜索会员" value="{{$keywords}}">
        ...
        <div class="box-body table-responsive">
            <table class="table table-hover table-bordered">
                ...
                <tbody class="dels">
                    ...
                    <tr>
                        <td class=""><input type="checkbox" value="{{$user['id']}}"></td>
                        <td class="text-muted">{{$user['name']}}</td>
                        <td class="text-muted">{{$user['email']}}</td>
                        <td class="text-muted">{{$user['remember_token']}}</td>
                        <td class="text-navy">{{$user['created_at']}}</td>
                        <td class="text-navy">{{$user['updated_at']}}</td>
                        <td>
                            <a style="font-size: 16px" href="/admin/users/edit/id/{{$user['id']}}"><i class="fa fa-fw fa-pencil" title="修改"></i></a>
                            <a style="font-size: 16px;color: #dd4b39;" href="JavaScript:void(0);" onclick="del({{$user['id']}})" delname="{{$user['id']}}"><i class="fa fa-fw fa-trash-o" title="删除"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
